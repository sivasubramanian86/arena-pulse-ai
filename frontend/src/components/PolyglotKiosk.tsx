...
export const PolyglotKiosk: React.FC = React.memo(() => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full" role="region" aria-label="Polyglot Kiosk: Split-Screen Translation">
      <div className="flex justify-between items-center bg-zinc-900/50 backdrop-blur border border-zinc-800 p-4 rounded-xl">
        <div>
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            ...
            Polyglot Tablet Kiosk
          </h2>
          <p className="text-xs text-zinc-400">
            Split-screen translator interface optimized for staff-to-fan interactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <div className="flex flex-col gap-4 bg-zinc-900/40 border border-zinc-800/80 p-6 rounded-2xl relative shadow-lg">
            <div className="flex justify-between items-center">
              <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Speaker A</span>
              <select
                value={leftLang}
                ...
                aria-label="Select Language for Speaker A"
              >
            ...
            <textarea
              ...
              aria-label={`Enter text in ${leftLang}`}
            />
            ...
            <div className="flex justify-between items-center mt-2">
              <button
                ...
                aria-label="Activate microphone input for Speaker A"
              >
              ...
              <button
                ...
                aria-label="Translate spoken phrase"
              >
          ...
          <div className="flex flex-col gap-4 bg-zinc-900/40 border border-zinc-800/80 p-6 rounded-2xl relative shadow-lg">
            <div className="flex justify-between items-center">
              <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Speaker B (Translation)</span>
              <select
                value={rightLang}
                onChange={(e) => setRightLang(e.target.value)}
                className="bg-zinc-950 border border-zinc-800 rounded-lg px-2.5 py-1 text-xs text-zinc-200 focus:outline-none focus:border-blue-500"
                aria-label="Select Target Language for Speaker B"
              >
                <option value="Spanish">Spanish</option>
                <option value="English">English</option>
                <option value="French">French</option>
            ...
            <div className="w-full bg-zinc-950/30 border border-zinc-800/60 rounded-xl p-4 text-sm text-zinc-200 min-h-[160px] flex flex-col justify-between">
              <p className={rightText ? "text-white" : "text-zinc-600 italic"}>
                {rightText || "Translation output will display here..."}
              </p>
              {isTranslating && (
            ...
            <div className="flex justify-start items-center mt-2">
              <button
                ...
                aria-label="Text to speech output for translation"
              >
